...
import { StyleSheet, Text, View, Dimensions, PixelRatio, TouchableHighlight, ProgressBar, Platform } from 'react-native';
...
export default class App extends Component {
  ...
  progressBar = () => {
    if(Platform.OS == 'android') {
      return <ProgressBar style={styles.slider} styleAttr="Horizontal" color="#e74c3c" indeterminate={false} progress={this.state.timer} />
    } else {
      return <Slider
          style={styles.slider}
          minimumValue={0}
